...
export const SEED_TASKS: Task[] = [
  {
    ...
    steps: [
      ...
      { id: "o6", title: "Copy review with Min", done: false },
      { id: "o7", title: "Analytics event map", done: false },
      { id: "o8", title: "Empty-state illustration", done: false },
      { id: "o9", title: "Legal + localization pass", done: false },
      { id: "o10", title: "Launch checklist", done: false },
    ],
    createdAt: hours(72),
    updatedAt: hours(2),
  },
